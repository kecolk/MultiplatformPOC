...
interface ApiService {
    ...
    @GET("https://api.stage.ifortuna.cz/offer/structure/api/v1_0/prematch/tournament/{tournamentId}/fixtures?marketFilterType=OVERVIEW&timeFilter=filter_default")
